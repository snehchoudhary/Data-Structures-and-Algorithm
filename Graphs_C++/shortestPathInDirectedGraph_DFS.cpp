...
//intitially maintain source
int src = topoOrder.top();
topoOrder.pop();
dist[src] =0 ;
//uodate the dist for neighbour of src node
 for(auto nbrPair: adj[src]){
        int nbrNode = nbrPair.first;
        int nbrDist = nbrPair.second;
...
//apply the same above code for all the remaining nodes
...
//ab mera distance array ekdm taiyar hai
